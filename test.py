...
options = [
  # first
	{
		'url': 'https://store.isseymiyake.com/c/pl_all_all/PP13JK531', 
		'item_to_buy': {
			(0, 0): 10,
		},
	...
	{
		'url': 'https://store.isseymiyake.com/c/pl_all_all/PP13JO172', 
		'item_to_buy': {
			(0, 0): 2,
      (1, 0): 2,
      (3, 0): 1, 
  ...
  # second
	...
	{
		'url': 'https://store.isseymiyake.com/c/pl_all_all/PP13JK942', 
		'item_to_buy': {
        (1, 0): 20,
		},
	...
	{
		'url': 'https://store.isseymiyake.com/c/pl_all_all/PP13JK941', 
		'item_to_buy': {
        (1, 0): 20,
		},
  ...
  # third
	...
	{
		'url': 'https://store.isseymiyake.com/c/pl_all_all/PP13JF174', 
		'item_to_buy': {
        (1, 0): 2,
        (1, 1): 5,
        (1, 2): 2,
